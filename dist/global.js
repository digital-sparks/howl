(() => {
  ...
  // node_modules/.pnpm/@gsap+shockingly@3.12.5/node_modules/@gsap/shockingly/utils/matrix.js
  var _doc3;
  var _win3;
  var _docElement2;
  var _body;
  ...
  // node_modules/.pnpm/@gsap+shockingly@3.12.5/node_modules/@gsap/shockingly/Draggable.js
  ...
  // node_modules/.pnpm/@gsap+shockingly@3.12.5/node_modules/@gsap/shockingly/utils/VelocityTracker.js
  var gsap3;
  var _coreInitted3;
  var _toArray2;
  var _getUnit;
  ...
  // node_modules/.pnpm/@gsap+shockingly@3.12.5/node_modules/@gsap/shockingly/InertiaPlugin.js
  var gsap4;
  var _coreInitted4;
  var _parseEase3;
  var _toArray3;
  ...
  window.Webflow.push(() => {
    ...
    document.querySelectorAll("[marquee=component]").forEach((marqueeEl) => {
      ...
      const gap = gsapWithCSS.getProperty(track, "grid-row-gap");
      console.log(gap);
      let totalX = 0;
      let marqueeH = 0;
      function calculatePositions() {
        ...
        allItems.forEach((item) => {
          gsapWithCSS.set(item, { width: "unset", height: "unset", position: "static" });
          const itemW = item.offsetWidth + gap;
          const itemH = item.offsetHeight;
          gsapWithCSS.set(item, { x: totalX, width: item.offsetWidth, height: itemH, position: "absolute" });
          totalX += itemW;
          if (itemH > marqueeH)
            marqueeH = itemH;
        });
        gsapWithCSS.set(marquee, { height: marqueeH, position: "relative" });
      }
      calculatePositions();
      const marqueeVal = gsapWithCSS.utils.wrap(0, totalX);
      const marqueeProgress = gsapWithCSS.utils.wrap(0, 1);
      function createAnimation() {
        const stringX = directionVal === -1 ? `-=${totalX}` : `+=${totalX}`;
        return gsapWithCSS.to(marquee.querySelectorAll("[marquee=slide]"), {
          repeat: -1,
          duration: 40,
          // Updated duration from 10 to 40 seconds
          x: stringX,
          ease: "none",
          paused: true,
          modifiers: {
...
@gsap/shockingly/utils/VelocityTracker.js:
  (*!
...
@gsap/shockingly/InertiaPlugin.js:
  (*!
