(() => {
  ...
  function ne(s, e) {
    s === void 0 && (s = {}),
      ...
      Object.keys(e).forEach((t) => {
        typeof s[t] > 'u'
          ? (s[t] = e[t])
          : be(e[t]) && be(s[t]) && Object.keys(e[t]).length > 0 && ne(s[t], e[t]);
      });
  }
  var Se = {
    body: {},
  ...
  function De(s) {
    return s === void 0 && (s = {}), ce || (ce = Fe(s)), ce;
  }
  var fe;
  function We() {
    let s = A(),
  ...
  function Ke() {
    ...
    typeof s.params.width < 'u' && s.params.width !== null
      ...
      !((e === 0 && s.isHorizontal()) || (t === 0 && s.isVertical())) &&
        ((e =
          e - parseInt(X(i, 'padding-left') || 0, 10) - parseInt(X(i, 'padding-right') || 0, 10)),
        (t =
          t - parseInt(X(i, 'padding-top') || 0, 10) - parseInt(X(i, 'padding-bottom') || 0, 10)),
        Number.isNaN(e) && (e = 0),
        Number.isNaN(t) && (t = 0),
  ...
  function st() {
    ...
    n &&
      ...
      e.forEach((f) => {
        ue(f, f === n, t.slideActiveClass),
          ue(f, f === c, t.slideNextClass),
    ...
    if ((i && s > n ? (c = n) : i && s < d ? (c = d) : (c = s), r.updateProgress(c), o.cssMode)) {
      ...
      if (e === 0) l[f ? 'scrollLeft' : 'scrollTop'] = -c;
        ...
        if (!r.support.smoothScroll)
          return oe({ swiper: r, targetPosition: -c, side: f ? 'left' : 'top' }), !0;
  ...
  function vt(s, e, t, i, a) {
    ...
    if (l.cssMode) {
      ...
      if (e === 0) {
        ...
        if (!r.support.smoothScroll)
          return oe({ swiper: r, targetPosition: g, side: m ? 'left' : 'top' }), !0;
  ...
  function Mt(s) {
    ...
    let a = () => {
      ...
      d = (c) => {
        for (let f = 0; f < c; f += 1) {
          let u = e.isElement
            ? V('swiper-slide', [t.slideBlankClass])
            : V('div', [t.slideClass, t.slideBlankClass]);
          e.slidesEl.append(u);
        }
      };
    if (l) {
  ...
  var Nt = { attachEvents: Rt, detachEvents: Xt },
        ...
        return (
          ...
          Object.assign(t, {
            ...
            rtlTranslate:
              ...
              (i.dir.toLowerCase() === 'rtl' || X(i, 'direction') === 'rtl'),
  ...
  Object.keys(me).forEach((s) => {
    Object.keys(me[s]).forEach((e) => {
      N.prototype[e] = me[s][e];
    });
  });
  N.use([qe, je]);
  function se(s) {
      ...
      if (
        ...
        if (!P) {
          ...
          if (
            ...
            e.updateActiveIndex(),
            e.updateSlidesClasses(),
            ((!B && e.isBeginning) || (!ae && e.isEnd)) && e.updateSlidesClasses(),
            e.params.loop &&
  ...
  window.Webflow.push(() => {
    console.log('hello'),
      (updatesCarousel = new N('.new_swiper-wrapper', {
        modules: [se, ie],
      ...
      (spotlightCarousel = new N('.spotlight_swiper-wrapper', {
        modules: [se, ie],
